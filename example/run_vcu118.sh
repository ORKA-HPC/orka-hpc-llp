...
target_board="vcu118"
export_dir="./generated_files_vcu118"
src_dir="./exampleip"
tlf="top"
clock="10ns"
cflags=""
...
${root}/../hw/orka_hw_configurator/configurator \
    -config ${root}/../hw/orka_hw_configurator/default_configs/vcu118dma.json \
    -o ${export_dir} \
...
## LOAD XDMA DRIVER (needs root privileges) ####################################
# path to xdma driver.
(cd "${root}/../3rdparty/xilinx_dma_drivers/XDMA/linux-kernel/tests" && sudo ./load_driver.sh)
