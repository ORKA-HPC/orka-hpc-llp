...
## GPIO 0 - Buttons and switches ##############################################
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0
apply_board_connection -board_interface "dip_switches_4bits" -ip_intf "axi_gpio_0/GPIO" -diagram $design_name
apply_board_connection -board_interface "push_buttons_5bits" -ip_intf "/axi_gpio_0/GPIO2" -diagram $design_name
...
apply_board_connection -board_interface "led_8bits" -ip_intf "axi_gpio_1/GPIO" -diagram $design_name
