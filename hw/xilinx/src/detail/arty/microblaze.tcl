...
apply_bd_automation -rule xilinx.com:bd_rule:microblaze -config { axi_intc {0} axi_periph {Enabled} cache {8KB} clk {/mig_0/ui_clk} debug_module {Debug Only} ecc {None} local_mem {128KB} preset {None}}  [get_bd_cells microblaze_0]
...
# connect to MIG SMC
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/mig_0/ui_clk} Clk_slave {/mig_0/ui_clk} Clk_xbar {/mig_0/ui_clk} Master {/microblaze_0/M_AXI_DC} Slave {/mig_0/S_AXI} intc_ip {/axi_smc} master_apm {0}}  [get_bd_intf_pins microblaze_0/M_AXI_DC]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config { Clk_master {/mig_0/ui_clk} Clk_slave {/mig_0/ui_clk} Clk_xbar {/mig_0/ui_clk} Master {/microblaze_0/M_AXI_IC} Slave {/mig_0/S_AXI} intc_ip {/axi_smc} master_apm {0}}  [get_bd_intf_pins microblaze_0/M_AXI_IC]
...
apply_bd_automation -rule xilinx.com:bd_rule:clkrst -config {Clk "/mig_0/ui_clk" }  [get_bd_pins axi_periph_interconnect/S0${pn}_ACLK]
incr pn
