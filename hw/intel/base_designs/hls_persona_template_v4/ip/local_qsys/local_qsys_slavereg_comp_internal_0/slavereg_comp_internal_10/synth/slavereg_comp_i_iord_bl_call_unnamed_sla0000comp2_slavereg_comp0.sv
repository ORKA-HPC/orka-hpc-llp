...
// SystemVerilog created from slavereg_comp_i_iord_bl_call_unnamed_sla0000comp2_slavereg_comp0
...
module slavereg_comp_i_iord_bl_call_unnamed_sla0000comp2_slavereg_comp0 (
    ...
    // iord(EXTIFACE,5)
    assign iord_i_fifodata = in_iord_bl_call_slavereg_comp_i_fifodata;
    ...
    assign iord_i_fifovalid = in_iord_bl_call_slavereg_comp_i_fifovalid;
    ...
    hld_iord #(
        ...
        .i_fifodata(in_iord_bl_call_slavereg_comp_i_fifodata),
    ...
    assign out_iord_bl_call_slavereg_comp_o_fifoalmost_full = iord_o_fifoalmost_full;

    // sync_out(GPOUT,20)@20000000
    assign out_o_stall = iord_o_stall;

    // dupName_0_regfree_osync_x(GPOUT,22)
    assign out_iord_bl_call_slavereg_comp_o_fifoready = iord_o_fifoready;

    // ip_dsdk_adapt_bitselect10(BITSELECT,6)
    assign ip_dsdk_adapt_bitselect10_b = iord_o_data[255:224];
