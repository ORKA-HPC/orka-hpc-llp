...
`timescale 1 ns / 1 ns
module ddr4_ctlr_mm_clock_bridge_altera_avalon_mm_clock_crossing_bridge_1920_zx5i67i 
#(
...
(
    ...
    ddr4_ctlr_mm_clock_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_kj72mxq #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    ddr4_ctlr_mm_clock_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_re6fw7q #(
        .SYMBOLS_PER_BEAT   (1),
