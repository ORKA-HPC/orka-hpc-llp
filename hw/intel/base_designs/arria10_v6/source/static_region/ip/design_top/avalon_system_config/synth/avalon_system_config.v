...
module avalon_system_config (
	...
	avalon_system_config_altera_avalon_onchip_memory2_1921_vomui5a pcie_subsystem_onchip_memory2_0 (
		.clk         (clk),         //   input,   width = 1,   clk1.clk
		.address     (address),     //   input,  width = 10,     s1.address
		.debugaccess (debugaccess), //   input,   width = 1,       .debugaccess
