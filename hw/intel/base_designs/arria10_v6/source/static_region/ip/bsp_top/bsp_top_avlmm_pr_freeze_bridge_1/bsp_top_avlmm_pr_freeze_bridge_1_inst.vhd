	component bsp_top_avlmm_pr_freeze_bridge_1 is
		port (
			...
			mst_bridge_to_pr_address            : in  std_logic_vector(30 downto 0)  := (others => 'X'); -- address
			mst_bridge_to_pr_byteenable         : in  std_logic_vector(63 downto 0)  := (others => 'X'); -- byteenable
			mst_bridge_to_pr_writedata          : in  std_logic_vector(511 downto 0) := (others => 'X'); -- writedata
			mst_bridge_to_pr_readdata           : out std_logic_vector(511 downto 0);                    -- readdata
			...
			mst_bridge_to_sr_address            : out std_logic_vector(30 downto 0);                     -- address
			mst_bridge_to_sr_byteenable         : out std_logic_vector(63 downto 0);                     -- byteenable
			mst_bridge_to_sr_writedata          : out std_logic_vector(511 downto 0);                    -- writedata
			mst_bridge_to_sr_readdata           : in  std_logic_vector(511 downto 0) := (others => 'X'); -- readdata
	...
	end component bsp_top_avlmm_pr_freeze_bridge_1;

	u0 : component bsp_top_avlmm_pr_freeze_bridge_1
		port map (
