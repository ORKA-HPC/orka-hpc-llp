...
module top_a10_pcie (
	...
	top_a10_pcie_altera_pcie_a10_hip_2010_vyno3qa #(
		...
		.bar4_type                                            ("bar4_32bit_non_prefetch_mem"),
		...
		.devkit_status                  (devkit_status),                                                                                                                                                                                                                                                         //  output,  width = 256,            dk_hip.devkit_status
		.devkit_ctrl                    (devkit_ctrl),                                                                                                                                                                                                                                                           //   input,  width = 256,                  .devkit_ctrl
