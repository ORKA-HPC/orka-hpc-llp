	component bsp_top_address_span_extender_0 is
		generic (
		...
		port (
			...
			avs_s0_address       : in  std_logic_vector(22 downto 0) := (others => 'X'); -- address
			...
			avm_m0_address       : out std_logic_vector(30 downto 0);                    -- address
	...
	end component bsp_top_address_span_extender_0;

	u0 : component bsp_top_address_span_extender_0
		generic map (
