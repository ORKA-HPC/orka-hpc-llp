...
module altpcie_sc_bitsync
  #(
   ...
   localparam MULTI_2      = {"-name SDC_STATEMENT \"set to_keeper_collection [get_keepers -nowarn *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]\"; -name SDC_STATEMENT \"if {[llength [query_collection -report -all $to_keeper_collection]] > 0} { set_multicycle_path -to [get_keepers *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]] 2 }\" "};
   localparam MULTI_3      = {"-name SDC_STATEMENT \"set to_keeper_collection [get_keepers -nowarn *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]\"; -name SDC_STATEMENT \"if {[llength [query_collection -report -all $to_keeper_collection]] > 0} { set_multicycle_path -to [get_keepers *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]] 3 }\" "};
   localparam FPATH        = {"-name SDC_STATEMENT \"set to_keeper_collection [get_keepers -nowarn *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]\"; -name SDC_STATEMENT \"if {[llength [query_collection -report -all $to_keeper_collection]] > 0} { set_false_path -to [get_keepers *"      , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]   }\" "};
   localparam FHOLD        = {"-name SDC_STATEMENT \"set to_keeper_collection [get_keepers -nowarn *" , NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]\"; -name SDC_STATEMENT \"if {[llength [query_collection -report -all $to_keeper_collection]] > 0} { set_false_path -hold -to [get_keepers *", NODENAME , "*altpcie_sc_bitsync_meta_dff\[*\]]   }\" "};
