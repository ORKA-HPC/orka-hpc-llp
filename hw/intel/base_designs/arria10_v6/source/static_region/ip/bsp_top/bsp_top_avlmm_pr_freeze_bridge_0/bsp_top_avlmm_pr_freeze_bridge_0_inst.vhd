	component bsp_top_avlmm_pr_freeze_bridge_0 is
		port (
			...
			slv_bridge_to_pr_address            : out std_logic_vector(15 downto 0);                    -- address
			slv_bridge_to_pr_byteenable         : out std_logic_vector(7 downto 0);                     -- byteenable
			slv_bridge_to_pr_writedata          : out std_logic_vector(63 downto 0);                    -- writedata
			slv_bridge_to_pr_readdata           : in  std_logic_vector(63 downto 0) := (others => 'X'); -- readdata
			...
			slv_bridge_to_sr_address            : in  std_logic_vector(15 downto 0) := (others => 'X'); -- address
			slv_bridge_to_sr_byteenable         : in  std_logic_vector(7 downto 0)  := (others => 'X'); -- byteenable
			slv_bridge_to_sr_writedata          : in  std_logic_vector(63 downto 0) := (others => 'X'); -- writedata
			slv_bridge_to_sr_readdata           : out std_logic_vector(63 downto 0);                    -- readdata
	...
	end component bsp_top_avlmm_pr_freeze_bridge_0;

	u0 : component bsp_top_avlmm_pr_freeze_bridge_0
		port map (
