...
`timescale 1 ns / 1 ns
module bsp_top_mm_clock_crossing_bridge_0_mm_ccb_1920_y6rzgka 
#(
...
(
    ...
    bsp_top_mm_clock_crossing_bridge_0_mm_ccb_st_dc_fifo_1920_feon2wy #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    bsp_top_mm_clock_crossing_bridge_0_mm_ccb_st_dc_fifo_1920_kouj56y #(
        .SYMBOLS_PER_BEAT   (1),
