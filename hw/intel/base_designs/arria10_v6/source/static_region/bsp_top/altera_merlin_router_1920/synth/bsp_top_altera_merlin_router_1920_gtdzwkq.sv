...
//    output_name             bsp_top_altera_merlin_router_1920_gtdzwkq
//    pkt_addr_h              99
//    pkt_addr_l              36
//    pkt_dest_id_h           120
//    pkt_dest_id_l           120
...
//    pkt_trans_read          103
//    pkt_trans_write         102
//    slaves_info             1:10:0x0:0x1000:both:1:0:0:1,0:01:0x1000:0x1100:both:1:0:0:1
//    st_channel_w            2
//    st_data_w               143
// ------------------------------------------

module bsp_top_altera_merlin_router_1920_gtdzwkq_default_decode
  #(
...
module bsp_top_altera_merlin_router_1920_gtdzwkq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    bsp_top_altera_merlin_router_1920_gtdzwkq_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 0: [0x0, 0x1000) : sel [12:12]
        if ( {address[12:12],{12 {1'b0}}} == 13'h0   ) begin
            src_channel = 2'b10;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
        end

        // slave 1: [0x1000, 0x1100) : sel [12:8]
        if ( {address[12:8],{8 {1'b0}}} == 13'h1000   ) begin
            src_channel = 2'b01;
