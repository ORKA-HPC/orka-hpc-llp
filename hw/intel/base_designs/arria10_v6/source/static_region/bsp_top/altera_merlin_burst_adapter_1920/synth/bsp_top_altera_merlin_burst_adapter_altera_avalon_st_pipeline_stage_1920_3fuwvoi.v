// bsp_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_3fuwvoi.v

// Generated using ACDS version 21.1 169

`timescale 1 ps / 1 ps
module bsp_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_3fuwvoi #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 666,
	...
	bsp_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 666,          .data
		...
		.out_data          (out_data),          //  output,  width = 666,          .data
