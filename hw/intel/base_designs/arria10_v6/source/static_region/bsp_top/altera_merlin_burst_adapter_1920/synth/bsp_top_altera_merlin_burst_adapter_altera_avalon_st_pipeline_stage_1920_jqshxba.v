// bsp_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_jqshxba.v

// Generated using ACDS version 21.1 169

`timescale 1 ps / 1 ps
module bsp_top_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_jqshxba #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 664,
	...
	bsp_top_altera_avalon_st_pipeline_stage_1920_zterisq #(
		...
		.in_data           (in_data),           //   input,  width = 664,          .data
		...
		.out_data          (out_data),          //  output,  width = 664,          .data
