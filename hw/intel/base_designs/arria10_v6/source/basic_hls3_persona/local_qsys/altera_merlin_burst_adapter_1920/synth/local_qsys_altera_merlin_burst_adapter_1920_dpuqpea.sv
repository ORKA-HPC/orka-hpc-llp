...
// parameterization.
// -----------------------------------------------------
module local_qsys_altera_merlin_burst_adapter_1920_dpuqpea 
#(
    parameter 
...
(
    ...
    generate if (COMPRESSED_READ_SUPPORT == 0) begin : altera_merlin_burst_adapter_uncompressed_only
        ...
        if(PIPE_INPUTS == 1) begin: pipe_inputs
            local_qsys_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1920_ozdqiky # (
                .SYMBOLS_PER_BEAT (1),
