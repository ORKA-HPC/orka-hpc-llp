...
`timescale 1 ns / 1 ns
module emif_avmm_interface_mm_clock_crossing_bridge_mm_ccb_1920_sndleca 
#(
...
(
    ...
    emif_avmm_interface_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1920_u4w4nii #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    emif_avmm_interface_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1920_dxeda4q #(
        .SYMBOLS_PER_BEAT   (1),
