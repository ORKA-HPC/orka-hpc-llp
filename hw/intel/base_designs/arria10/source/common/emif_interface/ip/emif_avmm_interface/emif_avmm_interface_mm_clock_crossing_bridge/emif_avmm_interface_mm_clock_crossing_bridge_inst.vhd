	component emif_avmm_interface_mm_clock_crossing_bridge is
		generic (
			DATA_WIDTH          : integer := 512;
			SYMBOL_WIDTH        : integer := 8;
			HDL_ADDR_WIDTH      : integer := 25;
			BURSTCOUNT_WIDTH    : integer := 7;
			COMMAND_FIFO_DEPTH  : integer := 128;
			RESPONSE_FIFO_DEPTH : integer := 128;
	...
	end component emif_avmm_interface_mm_clock_crossing_bridge;

	u0 : component emif_avmm_interface_mm_clock_crossing_bridge
		generic map (
