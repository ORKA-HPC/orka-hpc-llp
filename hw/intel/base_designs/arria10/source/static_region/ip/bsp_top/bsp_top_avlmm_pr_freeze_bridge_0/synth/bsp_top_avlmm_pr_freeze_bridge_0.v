// bsp_top_avlmm_pr_freeze_bridge_0.v
...
module bsp_top_avlmm_pr_freeze_bridge_0 (
	...
	bsp_top_avlmm_pr_freeze_bridge_0_altera_avlmm_pr_freeze_bridge_1911_62tbidq #(
		...
		.slv_bridge_to_pr_address            (slv_bridge_to_pr_address),            //  output,  width = 16,                 .address
		.slv_bridge_to_pr_byteenable         (slv_bridge_to_pr_byteenable),         //  output,   width = 8,                 .byteenable
		.slv_bridge_to_pr_writedata          (slv_bridge_to_pr_writedata),          //  output,  width = 64,                 .writedata
		.slv_bridge_to_pr_readdata           (slv_bridge_to_pr_readdata),           //   input,  width = 64,                 .readdata
		...
		.slv_bridge_to_sr_address            (slv_bridge_to_sr_address),            //   input,  width = 16,                 .address
		.slv_bridge_to_sr_byteenable         (slv_bridge_to_sr_byteenable),         //   input,   width = 8,                 .byteenable
		.slv_bridge_to_sr_writedata          (slv_bridge_to_sr_writedata),          //   input,  width = 64,                 .writedata
		.slv_bridge_to_sr_readdata           (slv_bridge_to_sr_readdata),           //  output,  width = 64,                 .readdata
