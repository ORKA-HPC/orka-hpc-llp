// bsp_top_mm_clock_crossing_bridge_0_mm_ccb_st_dc_fifo_1920_feon2wy.v

// Generated using ACDS version 21.1 169

`timescale 1 ps / 1 ps
module bsp_top_mm_clock_crossing_bridge_0_mm_ccb_st_dc_fifo_1920_feon2wy #(
		parameter SYMBOLS_PER_BEAT          = 1,
		parameter BITS_PER_SYMBOL           = 109,
		...
		input  wire [108:0] in_data,     //            in.data
		input  wire         in_valid,    //              .valid
		output wire         in_ready,    //              .ready
		output wire [108:0] out_data,    //           out.data
	...
	bsp_top_mm_clock_crossing_bridge_0_st_dc_fifo_1940_r4vdppy #(
		...
		.in_data            (in_data),                              //   input,  width = 109,            in.data
		.in_valid           (in_valid),                             //   input,    width = 1,              .valid
		.in_ready           (in_ready),                             //  output,    width = 1,              .ready
		.out_data           (out_data),                             //  output,  width = 109,           out.data
