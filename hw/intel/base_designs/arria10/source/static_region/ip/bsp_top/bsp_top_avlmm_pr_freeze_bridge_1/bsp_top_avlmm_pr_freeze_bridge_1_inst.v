	bsp_top_avlmm_pr_freeze_bridge_1 u0 (
		...
		.mst_bridge_to_pr_address            (_connected_to_mst_bridge_to_pr_address_),            //   input,   width = 31,                 .address
		.mst_bridge_to_pr_byteenable         (_connected_to_mst_bridge_to_pr_byteenable_),         //   input,   width = 64,                 .byteenable
		.mst_bridge_to_pr_writedata          (_connected_to_mst_bridge_to_pr_writedata_),          //   input,  width = 512,                 .writedata
		.mst_bridge_to_pr_readdata           (_connected_to_mst_bridge_to_pr_readdata_),           //  output,  width = 512,                 .readdata
		...
		.mst_bridge_to_sr_address            (_connected_to_mst_bridge_to_sr_address_),            //  output,   width = 31,                 .address
		.mst_bridge_to_sr_byteenable         (_connected_to_mst_bridge_to_sr_byteenable_),         //  output,   width = 64,                 .byteenable
		.mst_bridge_to_sr_writedata          (_connected_to_mst_bridge_to_sr_writedata_),          //  output,  width = 512,                 .writedata
		.mst_bridge_to_sr_readdata           (_connected_to_mst_bridge_to_sr_readdata_),           //   input,  width = 512,                 .readdata
