module bsp_top_address_span_extender_0 #(
		parameter SYNC_RESET = 0
	) (
		input  wire        clk,                  //           clock.clk
		input  wire        reset,                //           reset.reset
		input  wire [22:0] avs_s0_address,       //  windowed_slave.address
		...
		input  wire [7:0]  avs_s0_byteenable,    //                .byteenable
		input  wire [3:0]  avs_s0_burstcount,    //                .burstcount
		output wire [30:0] avm_m0_address,       // expanded_master.address
