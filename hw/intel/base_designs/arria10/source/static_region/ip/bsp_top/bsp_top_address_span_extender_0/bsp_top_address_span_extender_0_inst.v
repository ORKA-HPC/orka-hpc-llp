	bsp_top_address_span_extender_0 #(
		...
		.avs_s0_address       (_connected_to_avs_s0_address_),       //   input,  width = 23,  windowed_slave.address
		.avs_s0_read          (_connected_to_avs_s0_read_),          //   input,   width = 1,                .read
		.avs_s0_readdata      (_connected_to_avs_s0_readdata_),      //  output,  width = 64,                .readdata
		.avs_s0_write         (_connected_to_avs_s0_write_),         //   input,   width = 1,                .write
		.avs_s0_writedata     (_connected_to_avs_s0_writedata_),     //   input,  width = 64,                .writedata
		...
		.avs_s0_byteenable    (_connected_to_avs_s0_byteenable_),    //   input,   width = 8,                .byteenable
		.avs_s0_burstcount    (_connected_to_avs_s0_burstcount_),    //   input,   width = 4,                .burstcount
		.avm_m0_address       (_connected_to_avm_m0_address_),       //  output,  width = 31, expanded_master.address
		...
		.avm_m0_readdata      (_connected_to_avm_m0_readdata_),      //   input,  width = 64,                .readdata
		.avm_m0_write         (_connected_to_avm_m0_write_),         //  output,   width = 1,                .write
		.avm_m0_writedata     (_connected_to_avm_m0_writedata_),     //  output,  width = 64,                .writedata
		.avm_m0_readdatavalid (_connected_to_avm_m0_readdatavalid_), //   input,   width = 1,                .readdatavalid
		.avm_m0_byteenable    (_connected_to_avm_m0_byteenable_),    //  output,   width = 8,                .byteenable
