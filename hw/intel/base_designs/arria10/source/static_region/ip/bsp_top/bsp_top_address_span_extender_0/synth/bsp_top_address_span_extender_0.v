// bsp_top_address_span_extender_0.v
...
module bsp_top_address_span_extender_0 #(
	...
	bsp_top_address_span_extender_0_altera_address_span_extender_1920_6zmupsi #(
		.DATA_WIDTH           (64),
		.BYTEENABLE_WIDTH     (8),
		.MASTER_ADDRESS_WIDTH (31),
		.SLAVE_ADDRESS_WIDTH  (23),
		...
		.avs_s0_address       (avs_s0_address),       //   input,  width = 23,  windowed_slave.address
		.avs_s0_read          (avs_s0_read),          //   input,   width = 1,                .read
		.avs_s0_readdata      (avs_s0_readdata),      //  output,  width = 64,                .readdata
		.avs_s0_write         (avs_s0_write),         //   input,   width = 1,                .write
		.avs_s0_writedata     (avs_s0_writedata),     //   input,  width = 64,                .writedata
		...
		.avs_s0_byteenable    (avs_s0_byteenable),    //   input,   width = 8,                .byteenable
		.avs_s0_burstcount    (avs_s0_burstcount),    //   input,   width = 4,                .burstcount
		.avm_m0_address       (avm_m0_address),       //  output,  width = 31, expanded_master.address
		.avm_m0_read          (avm_m0_read),          //  output,   width = 1,                .read
		.avm_m0_waitrequest   (avm_m0_waitrequest),   //   input,   width = 1,                .waitrequest
		.avm_m0_readdata      (avm_m0_readdata),      //   input,  width = 64,                .readdata
		.avm_m0_write         (avm_m0_write),         //  output,   width = 1,                .write
		.avm_m0_writedata     (avm_m0_writedata),     //  output,  width = 64,                .writedata
		.avm_m0_readdatavalid (avm_m0_readdatavalid), //   input,   width = 1,                .readdatavalid
		.avm_m0_byteenable    (avm_m0_byteenable),    //  output,   width = 8,                .byteenable
