...
`timescale 1 ns / 1 ns
module bsp_top_mm_clock_crossing_bridge_1_mm_ccb_1920_5p3ibgq 
#(
...
(
    ...
    bsp_top_mm_clock_crossing_bridge_1_mm_ccb_st_dc_fifo_1920_oiegtky #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    bsp_top_mm_clock_crossing_bridge_1_mm_ccb_st_dc_fifo_1920_2lpfjsa #(
        .SYMBOLS_PER_BEAT   (1),
