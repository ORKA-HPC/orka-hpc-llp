...
`timescale 1 ns / 1 ns
module pcie_mm_clock_crossing_bridge_mm_ccb_1920_5p3ibgq 
#(
...
(
    ...
    pcie_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1920_mdsb74q #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    pcie_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1920_2lpfjsa #(
        .SYMBOLS_PER_BEAT   (1),
