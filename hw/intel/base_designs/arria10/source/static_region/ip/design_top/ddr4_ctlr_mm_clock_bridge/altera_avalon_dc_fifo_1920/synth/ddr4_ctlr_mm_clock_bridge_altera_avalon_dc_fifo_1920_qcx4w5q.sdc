...
#-------------------------------------------------------------------------------
set all_dc_fifo [get_entity_instances ddr4_ctlr_mm_clock_bridge_altera_avalon_dc_fifo_1920_qcx4w5q]
...
set mem_regs [get_registers -nowarn *|ddr4_ctlr_mm_clock_bridge_altera_avalon_dc_fifo_1920_qcx4w5q:*|mem*];
if {![llength [query_collection -report -all $mem_regs]] > 0} {
    set mem_regs [get_registers -nowarn ddr4_ctlr_mm_clock_bridge_altera_avalon_dc_fifo_1920_qcx4w5q:*|mem*];
}

set internal_out_payload_regs [get_registers -nowarn *|ddr4_ctlr_mm_clock_bridge_altera_avalon_dc_fifo_1920_qcx4w5q:*|internal_out_payload*];
