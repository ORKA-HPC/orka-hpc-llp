// ddr4_ctlr_mm_clock_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_kj72mxq.v

// Generated using ACDS version 20.2 50

`timescale 1 ps / 1 ps
module ddr4_ctlr_mm_clock_bridge_altera_avalon_mm_clock_crossing_bridge_altera_avalon_dc_fifo_1920_kj72mxq #(
		parameter SYMBOLS_PER_BEAT          = 1,
		parameter BITS_PER_SYMBOL           = 611,
		...
		input  wire [610:0] in_data,     //            in.data
		input  wire         in_valid,    //              .valid
		output wire         in_ready,    //              .ready
		output wire [610:0] out_data,    //           out.data
	...
	ddr4_ctlr_mm_clock_bridge_altera_avalon_dc_fifo_1920_qcx4w5q #(
		...
		.in_data            (in_data),                              //   input,  width = 611,            in.data
		.in_valid           (in_valid),                             //   input,    width = 1,              .valid
		.in_ready           (in_ready),                             //  output,    width = 1,              .ready
		.out_data           (out_data),                             //  output,  width = 611,           out.data
