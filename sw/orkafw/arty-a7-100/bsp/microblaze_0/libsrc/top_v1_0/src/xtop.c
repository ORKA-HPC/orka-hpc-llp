...
void XTop_Set_OrkaAxiPort0(XTop *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XTop_WriteReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT0_DATA, (u32)(Data));
    XTop_WriteReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT0_DATA + 4, (u32)(Data >> 32));
}

u64 XTop_Get_OrkaAxiPort0(XTop *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XTop_ReadReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT0_DATA);
    Data += (u64)XTop_ReadReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT0_DATA + 4) << 32;
    return Data;
}

void XTop_Set_OrkaAxiPort1(XTop *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XTop_WriteReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT1_DATA, (u32)(Data));
    XTop_WriteReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT1_DATA + 4, (u32)(Data >> 32));
}

u64 XTop_Get_OrkaAxiPort1(XTop *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XTop_ReadReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT1_DATA);
    Data += (u64)XTop_ReadReg(InstancePtr->Axilites_BaseAddress, XTOP_AXILITES_ADDR_ORKAAXIPORT1_DATA + 4) << 32;
    return Data;
}
